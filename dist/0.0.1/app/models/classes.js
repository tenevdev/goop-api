...
var identifierMatch = [
  ...
  "({VALUE}) is not a valid idetifier"
];
...
classSchema.methods = {
  ...
  //   var index = require('mout/array/findIndex')(this.notes, {
  //     id: noteId
  //   });
  //   if (~index) this.comments.splice(index, 1);
  //   else return cb('Note not found');
  //   this.save(cb);
  // }
...
classSchema.statics = {
  ...
  getByUserId: function(options, id, cb) {
    options.filter.author = id;
