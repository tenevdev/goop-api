...
var param = require("../paramTypes.js");
var url = require("url");
var swe = sw.errors;

var petData = require("../services/services.js");
...
exports.findById = {
  'spec': {
    ...
    parameters: [param.path("petId", "ID of pet that needs to be fetched",
      "string")],
...
exports.findByTags = {
  ...
  'action': function(req, res) {
    ...
    var data = petData.findPetByTags(tagsString);
    sw.setHeaders(res);
...
exports.updatePet = {
  'spec': {
    ...
    parameters: [param.body("Pet",
      "Pet object that needs to be updated in the store", "Pet")],
    responseMessages: [swe.invalid('id'), swe.notFound('pet'), swe.invalid(
      'input')],
    nickname: "addPet"
  },
  'action': function(req, res) {
...
exports.deletePet = {
  'spec': {
    ...
    parameters: [param.path("id", "ID of pet that needs to be removed",
      "string")],
    responseMessages: [swe.invalid('id'), swe.notFound('pet')],
    nickname: "deletePet"
  },
